//Se usa concatenacion de cadenas
let table = "<table>";
table += "<thead>";
table += "<tr>";
...
const alumnos = [
    ...
    { id: 3, nombre: "Alexis Armando", apellido:"Quintanilla Peña", correo:"alex.quintanilla@estudiante.esen.edu.sv"},
...
//agregar filas de los datos a la tabla
